...
async def Cadastro(interaction: discord.Interaction, name: str):    
    view = DropDownView()
    await interaction.response.send_message(f'**Selecione o jogo que deseja cadastrar! {name}**',view=view, ephemeral = True) 
"""
@client.event
async def on_ready():
